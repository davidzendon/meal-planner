...
const RECIPES = {
  'vegan-saag': {
    ...
    steps: [
      "Preheat oven to 375°F. Press tofu to remove excess moisture, then cut into 1.5-inch cubes.",
  ...
  'lentil-soup': {
    ...
    steps: [
      ...
      "Heat olive oil in large pot over medium heat. Add diced onion, carrots, and celery. Sauté until softened, about 8-10 minutes.",
  ...
  'tofu-salad': {
    ...
    steps: [
      "Preheat oven to 400°F. Press tofu firmly between paper towels to remove excess moisture. Cut into 3/4-inch cubes.",
  ...
  'indomie-ramen': {
    ...
    prepTime: '5 min',
    cookTime: '10 min',
    summary: "Quick Indonesian instant noodles elevated with sautéed shiitake mushrooms.",
    steps: [
      ...
      "Slice scallions thinly.",
      "Divide noodles between bowls. Top with sautéed shiitake mushrooms and scallions.",
          ...
          >
            ...
            >
              ...
              <div style={{ 
                ...
                <span>🍽️ Serves {RECIPES[showRecipeInfo].servings}</span>
                <span>⏱️ Prep: {RECIPES[showRecipeInfo].prepTime}</span>
                <span>🔥 Cook: {RECIPES[showRecipeInfo].cookTime}</span>
              </div>
